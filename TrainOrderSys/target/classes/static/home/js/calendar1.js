;window.replace = function() {
    ...
    var f = {
        ...
        get: function(a) {
            if (!a) return f.log("Date is null, Can't create calendar1 data structure."),
            null;
    ...
    h.prototype = {
        ...
        _create: function(a, b) {
            ...
            return c.tmpl.render(g.calendar1, {
                title: l,
                monthclass: (b ? " " + b: ""),
                data: k
            })
